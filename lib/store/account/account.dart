...
import 'package:dicolite/store/account/types/accountBondedInfo.dart';
import 'package:dicolite/store/account/types/accountData.dart';
import 'package:dicolite/store/account/types/accountRecoveryInfo.dart';
...
abstract class _AccountStore with Store {
  ...
  String get currentAddress {
    int ss58 = rootStore.settings?.endpoint.ss58 ?? Config.default_ss58_prefix;

    return pubKeyAddressMap[ss58] != null
        ? pubKeyAddressMap[ss58]![currentAccountPubKey] ??
  ...
  Future<void> loadAccount() async {
    ...
    currentAccountPubKey =
        await rootStore.localStorage.getCurrentAccount() ?? "";
    loading = false;
  }
  ...
  @action
  void setAccountRecoveryInfo(Map<String, dynamic>? json) {
