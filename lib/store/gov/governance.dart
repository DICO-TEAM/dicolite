...
import 'package:dicolite/store/gov/types/councilInfoData.dart';
...
abstract class _GovernanceStore with Store {
  ...
  @action
  void setCouncilInfo(Map<String, dynamic> info, {bool shouldCache = true}) {
  ...
  Future<void> loadCache() async {
    Map? data = await rootStore.localStorage
        .getObject(_getCacheKey(cacheCouncilKey)) as Map?;
    if (data != null) {
  ...
  @action
  void setTreasuryOverview(Map<String, dynamic> data) {
