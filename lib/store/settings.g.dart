...
mixin _$SettingsStore on _SettingsStore, Store {
  ...
  List<AccountData> get contactListAll => (_$contactListAllComputed ??=
      ...
      .value;
  Computed<String>? _$versionNameComputed;

  @override
  String get versionName =>
      (_$versionNameComputed ??= Computed<String>(() => super.versionName,
              name: '_SettingsStore.versionName'))
          .value;
  Computed<int>? _$blockDurationComputed;

  @override
  int get blockDuration =>
      (_$blockDurationComputed ??= Computed<int>(() => super.blockDuration,
              name: '_SettingsStore.blockDuration'))
          .value;
