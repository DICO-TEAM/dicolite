...
class ApiGovernance {
  ...
  Future<Map> fetchTreasuryOverview() async {
    Map<String, dynamic> data = await apiRoot.evalJavascript(
    ...
    allProposals.addAll(
        store.gov!.treasuryOverview.approvals as List<SpendProposalData>);
  ...
  Future<void> updateBestNumber() async {
    ...
    store.gov!.setBestNumber(int.parse(bestNumber.toString()));
  }
}
